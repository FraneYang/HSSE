...
namespace BLL
{
    public static class FileCabinetAItemService
    {
        ...
        {
            Model.HSSEDB_ENN db = Funs.DB;
            Model.InformationProject_FileCabinetAItem newFileCabinetAItem = db.InformationProject_FileCabinetAItem.FirstOrDefault(e => e.FileCabinetAItemId == FileCabinetAItem.FileCabinetAItemId);
            if (newFileCabinetAItem != null)
            {
                newFileCabinetAItem.FileCabinetAId = FileCabinetAItem.FileCabinetAId;
