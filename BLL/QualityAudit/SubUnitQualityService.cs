...
namespace BLL
{
    ...
    public static class SubUnitQualityService
    {
        ...
        //{
        //    return db.QualityAudit_SubUnitQuality.FirstOrDefault(e => e.SubUnitQualityId == subUnitQualityId);
        //}
        ...
        {
            return db.QualityAudit_SubUnitQuality.FirstOrDefault(e => e.UnitId == unitId);
        }
