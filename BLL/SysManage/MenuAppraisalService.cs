...
namespace BLL
{
    public static class MenuAppraisalService
    {
        ...
        public static void AddMenuAppraisal(Model.Sys_MenuAppraisal menuAppraisal)
        {
            ...
            {
                AppraisalId = SQLHelper.GetNewID(typeof(Model.Sys_MenuAppraisal)),
                MenuId = menuAppraisal.MenuId,
                MenuOperation = menuAppraisal.MenuOperation,
                Score = menuAppraisal.Score,
                OutTime = menuAppraisal.OutTime,
        ...
        public static void UpdateMenuAppraisal(Model.Sys_MenuAppraisal menuAppraisal)
        {
            ...
            if (newMenuAppraisal != null)
            {
                ...
                newMenuAppraisal.OutTime = menuAppraisal.OutTime;
                newMenuAppraisal.MenuOperationName = menuAppraisal.MenuOperationName;
                Funs.DB.SubmitChanges();
            }
        }
