    ...
    public static class PlanService
    {
        ...
        public static void AddPlan(Model.Training_Plan plan)
        {
            Model.Training_Plan newPlan = new Model.Training_Plan
            {
                ...
                InstallationNames = plan.InstallationNames,
                States = plan.States
            };
        ...
        public static void UpdatePlan(Model.Training_Plan plan)
        {
            ...
            if (newPlan != null)
            {
                ...
                newPlan.InstallationIds = plan.InstallationIds;
                newPlan.InstallationNames = plan.InstallationNames;
        ...
        public static void DeletePlanById(string planId)
        {
            ...
            if (plan != null)
            {
                CommonService.DeleteSysPushRecordByDataId(planId);
