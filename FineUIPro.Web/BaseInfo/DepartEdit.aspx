<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartEdit.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.DepartEdit" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                     <f:TextBox ID="txtDepartCode" runat="server" Label="编号"  MaxLength="20" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtDepartName" runat="server" Label="名称" Required="true" ShowRedStar="true"  MaxLength="20"
