...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急救援类型" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="EmergencyTypeId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="EmergencyTypeId" AllowSorting="true" SortField="EmergencyTypeCode"
                ...
                <Columns>
                   ...
                   <f:RenderField Width="150px" ColumnID="EmergencyTypeCode" DataField="EmergencyTypeCode" FieldType="String"
                    ...
                    <f:RenderField Width="250px" ColumnID="EmergencyTypeName" DataField="EmergencyTypeName" FieldType="String"
    ...
    <f:Window ID="Window1" Title="应急救援类型" Hidden="true" EnableIFrame="true" EnableMaximize="true"
