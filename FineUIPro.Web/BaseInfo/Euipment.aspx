<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Euipment.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.Euipment" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="设备设施" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="EuipmentId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="EuipmentId" AllowSorting="true" SortField="WorkAreaCode,EuipmentCode"
                ...
                <Columns>
                    <f:TemplateField ColumnID="tfNumber" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center">
                     ...
                     <f:RenderField Width="95px" ColumnID="EuipmentCode" DataField="EuipmentCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="140px" ColumnID="InstallationName" DataField="InstallationName" FieldType="String"
                        HeaderText="所属单位(装置)" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="150px" ColumnID="WorkAreaName" DataField="WorkAreaName" FieldType="String"
                        HeaderText="所属单元(区域)" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>                   
                     <f:RenderField Width="160px" ColumnID="EuipmentName" DataField="EuipmentName" FieldType="String"
                        HeaderText="设备设施" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                      <f:RenderField Width="100px" ColumnID="EuipmentNo" DataField="EuipmentNo" FieldType="String"
                    ...
                    <f:RenderField Width="90px" ColumnID="RiskLevelName" DataField="RiskLevelName" FieldType="String"
    ...
    <f:Window ID="Window1" Title="设备设施" Hidden="true" EnableIFrame="true" EnableMaximize="true"
