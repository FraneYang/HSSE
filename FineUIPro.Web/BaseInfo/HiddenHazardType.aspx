<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HiddenHazardType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.HiddenHazardType" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="隐患类别" EnableCollapse="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                         <Items>
                              <f:TextBox runat="server" Label="隐患类别" ID="txtHiddenHazardTypeName" EmptyText="输入查询条件" AutoPostBack="true"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="120px" ColumnID="HiddenHazardTypeCode" DataField="HiddenHazardTypeCode" SortField="HiddenHazardTypeCode"
                        FieldType="String" HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="350px" ColumnID="HiddenHazardTypeName" DataField="HiddenHazardTypeName" SortField="HiddenHazardTypeName"
    ...
    <f:Window ID="Window1" Title="隐患类别" Hidden="true" EnableIFrame="true" EnableMaximize="true"
