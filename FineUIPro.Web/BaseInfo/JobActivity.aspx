<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobActivity.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.JobActivity" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="作业活动" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="JobActivityId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="JobActivityId" AllowSorting="true" SortField="WorkAreaCode,JobActivityCode"
                ...
                <Columns>
                    <f:TemplateField ColumnID="tfNumber" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center">
                     ...
                     <f:RenderField Width="100px" ColumnID="JobActivityCode" DataField="JobActivityCode" FieldType="String"
                    ...
                    <f:RenderField Width="300px" ColumnID="WorkAreaName" DataField="WorkAreaName" FieldType="String"
                        HeaderText="作业活动地点(区域单元)" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>                   
    ...
    <f:Window ID="Window1" Title="作业活动" Hidden="true" EnableIFrame="true" EnableMaximize="true"
