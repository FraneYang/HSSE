<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverhaulRiskGrade.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.OverhaulRiskGrade" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="作业风险对应值" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="OverhaulRiskGradeId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="OverhaulRiskGradeId" AllowSorting="true" SortField="RiskGrade"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />                   
                    <f:RenderField Width="200px" ColumnID="RiskGrade" DataField="RiskGrade" FieldType="String"
    ...
    <f:Window ID="Window1" Title="作业风险对应值" Hidden="true" EnableIFrame="true" EnableMaximize="true"
