<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Position.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.Position" %>
...
<body>
            ...
            <f:Grid ID="Grid1" Title="职务信息" ShowHeader="false" EnableCollapse="true" PageSize="10"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="150px" ColumnID="PositionCode" DataField="PositionCode" FieldType="String"
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtPositionCode.ClientID %>';
        var txtNameClientID = '<%= txtPositionName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['PositionCode']);
            F(txtNameClientID).setValue(rowValue['PositionName']);
