...
namespace FineUIPro.Web.BaseInfo
{
    public partial class Position : PageBase
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            BLL.LogService.AddLog( this.CurrUser.UserId, "删除职务信息");
            // 重新绑定表格，并模拟点击[新增按钮]
            BindGrid();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(strRowID))
            {
                ...
                BLL.LogService.AddLog( this.CurrUser.UserId, "添加职务信息");
            }
            else
            {
                position.PositionId = strRowID;
                BLL.PositionService.UpdatePosition(position);
                BLL.LogService.AddLog( this.CurrUser.UserId, "修改职务信息");
            }
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList( this.CurrUser.UserId, BLL.Const.PositionMenuId);
