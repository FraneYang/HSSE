    ...
    public partial class PostTitle : PageBase
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            if (judgementDelete(hfFormID.Text, true))
            {
                ...
                BLL.LogService.AddLog(this.CurrUser.UserId, "删除专家职称");
                // 重新绑定表格，并模拟点击[新增按钮]
                BindGrid();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(strRowID))
            {
                ...
                BLL.LogService.AddLog(this.CurrUser.UserId, "添加专家职称");
            }
            else
            {
                depart.PostTitleId = strRowID;
                BLL.PostTitleService.UpdatePostTitle(depart);
                BLL.LogService.AddLog(this.CurrUser.UserId, "修改专家职称");
            }
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList( this.CurrUser.UserId, BLL.Const.PostTitleMenuId);
