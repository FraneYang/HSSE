<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prospective.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.Prospective" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="准操项目" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="ProspectiveId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="ProspectiveId" AllowSorting="true" SortField="ProspectiveCode"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                   <f:RenderField Width="150px" ColumnID="ProspectiveCode" DataField="ProspectiveCode" FieldType="String"
                        HeaderText="编码" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="500px" ColumnID="ProspectiveName" DataField="ProspectiveName" FieldType="String"
    ...
    <f:Window ID="Window1" Title="准操项目" Hidden="true" EnableIFrame="true" EnableMaximize="true"
