    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="风险等级对应值" EnableCollapse="true"
                ...
                ClicksToEdit="2" DataIDField="RiskLevelValueId" AllowSorting="true" SortField="Identification,SortIndex"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                         <Items>
                             <f:TextBox runat="server" Label="查询" ID="txtRiskLevelName" EmptyText="输入查询条件" AutoPostBack="true"
                                OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="80px" LabelAlign="Right">
                            </f:TextBox>         
                             <f:ToolbarFill ID="ToolbarFill1" runat="server">
                            </f:ToolbarFill>        
                            <f:Button ID="btnArrowRefresh" Icon="ArrowRefresh" runat="server" Hidden="true" ToolTip="刷新评价方法、风险库的风险等级"
                                OnClick="btnArrowRefresh_Click">
                            </f:Button>
                        </Items>
                    </f:Toolbar>
                </Toolbars>
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                     ...
                     <f:RenderField Width="90px" ColumnID="Identification" DataField="Identification" FieldType="String"
                        HeaderText="评价方法" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="90px" ColumnID="RiskLevelName" DataField="RiskLevelName" FieldType="String"
                     ...
                     <f:RenderField Width="90px" ColumnID="MinValue" DataField="MinValue" 
                        FieldType="String" HeaderText="最小值" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField Width="90px" ColumnID="MaxValue" DataField="MaxValue" 
                        FieldType="String" HeaderText="最大值" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="400px" ColumnID="ControlMeasures" DataField="ControlMeasures" 
                        FieldType="String" HeaderText="控制措施" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="LimitTime" DataField="LimitTime" 
                        FieldType="String" HeaderText="实施期限" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
