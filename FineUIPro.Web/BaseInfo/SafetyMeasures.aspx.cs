    ...
    public partial class SafetyMeasures : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            { 
                ...
                BLL.ConstValue.InitConstValueDropDownList(this.drpLicenseType, ConstValue.Group_LicenseType, true);
                // 绑定表格
                this.BindGrid();
            }
        }
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.UserId, BLL.Const.SafetyMeasuresMenuId);
            ...
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    if (judgementDelete(rowID, false))
                    {
                        ...
                        BLL.LogService.AddLog( this.CurrUser.UserId, "删除安全措施");
                    }
                }
                BindGrid();
                ShowNotify("删除数据成功!");
