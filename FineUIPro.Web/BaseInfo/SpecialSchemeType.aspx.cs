    ...
    public partial class SpecialSchemeType :PageBase
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            if (judgementDelete(hfFormID.Text, true))
            {
                ...
                BLL.LogService.AddLog(this.CurrUser.UserId, "删除施工方案类别");
                // 重新绑定表格，并模拟点击[新增按钮]
                BindGrid();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(strRowID))
            {
                ...
                BLL.LogService.AddLog(this.CurrUser.UserId, "添加施工方案类别");
            }
            else
            {
                depart.SpecialSchemeTypeId = strRowID;
                BLL.SpecialSchemeTypeService.UpdateSpecialSchemeType(depart);
                BLL.LogService.AddLog(this.CurrUser.UserId, "修改施工方案类别");
            }
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.UserId, BLL.Const.SpecialSchemeTypeMenuId);
