<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Specialty.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.Specialty" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="标准名称" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="SpecialtyId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="SpecialtyId" AllowSorting="true" SortField="SpecialtyCode"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />                   
                    <f:RenderField Width="200px" ColumnID="SpecialtyCode" DataField="SpecialtyCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                      <f:RenderField Width="400px" ColumnID="SpecialtyName" DataField="SpecialtyName" FieldType="String"
                        HeaderText="专业名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
