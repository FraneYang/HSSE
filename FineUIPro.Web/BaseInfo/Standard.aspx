<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Standard.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.Standard" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="标准名称" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="StandardId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="StandardId" AllowSorting="true" SortField="SpecialtyCode,StandardCode"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="180px" ColumnID="StandardCode" DataField="StandardCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField Width="400px" ColumnID="StandardName" DataField="StandardName" FieldType="String"
                    ...
                    <f:WindowField TextAlign="Center" Width="80px" WindowID="WindowAtt" HeaderText="原文"
                        Text="查看" ToolTip="原文查看" DataIFrameUrlFields="StandardId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/Standard"/>
                </Columns>
                <Listeners>
    ...
    <f:Window ID="Window1" Title="标准名称" Hidden="true" EnableIFrame="true" EnableMaximize="true"
