...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="培训类别" Layout="HBox"
        ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="培训类别" ShowHeader="false" EnableCollapse="true" PageSize="10"
                EnableColumnLines="true" ShowBorder="true" AllowPaging="true" IsDatabasePaging="true"
                runat="server" Width="780px" DataKeyNames="TrainTypeId" DataIDField="TrainTypeId"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="100px" ColumnID="TrainTypeCode" DataField="TrainTypeCode" FieldType="String"
                        HeaderText="类别编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="250px" ColumnID="TrainTypeName" DataField="TrainTypeName" FieldType="String"
                        HeaderText="类别名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtTrainTypeCode" Label="类别编号" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged"
                        LabelWidth="100px">
                    </f:TextBox>
                    <f:TextBox ID="txtTrainTypeName" Label="类别名称" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged"
                        LabelWidth="100px">
                    </f:TextBox>
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Bottom" runat="server" ToolbarAlign="Center">
                        <Items>
