<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.UnitType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
        ...
        <Items>
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtUnitTypeName" Label="名称" ShowRedStar="true" Required="true" runat="server"  MaxLength="50"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextArea ID="txtRemark" runat="server" Label="备注" LabelAlign="right"  MaxLength="50">
                    </f:TextArea>
                </Items>
                <Toolbars>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtUnitTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtUnitTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['UnitTypeCode']);
            F(txtNameClientID).setValue(rowValue['UnitTypeName']);
