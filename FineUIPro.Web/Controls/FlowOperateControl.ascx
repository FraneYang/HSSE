                ...
                <Items>
                    <f:Form ID="Form1" ShowBorder="false" ShowHeader="false"  AutoScroll="true"
                        ...
                        <Rows>
                            ...
                            <f:FormRow ColumnWidths="30% 5% 40% 20%">
                                <Items>
                                    <f:RadioButtonList ID="rblFlowOperate" runat="server" MarginLeft="35px" OnSelectedIndexChanged="rblFlowOperate_SelectedIndexChanged" AutoPostBack="true">
                                        <f:RadioItem Value="1" Text="下一步" Selected="true" />
                                        <f:RadioItem Value="2" Text="审批完成" />
                                    </f:RadioButtonList>
                                    <f:ToolbarSeparator ID="ToolbarSeparator1" runat="server"></f:ToolbarSeparator>                                 
                                    <f:DropDownList ID="drpPerson" runat="server" Label="办理人员" EnableEdit="true">
                                    </f:DropDownList>                              
                                    <f:CheckBox ID="IsFileCabinetA" MarginLeft="50px" Hidden="true" LabelWidth="250px" runat="server" Text="【文件柜A】"></f:CheckBox>
                                </Items>
                            </f:FormRow>
                        </Rows>
                    </f:Form>                      
