<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentCaseEdit.aspx.cs" Inherits="FineUIPro.Web.EduTrain.AccidentCaseEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>编辑事故案例库主表</title>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="SimpleForm1" runat="server" />
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                   <f:TextBox ID="txtSupAccidentCase" runat="server" Label="上级名称" Required="true" ShowRedStar="true" FocusOnPageLoad="true" MaxLength="50"></f:TextBox>                    
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
