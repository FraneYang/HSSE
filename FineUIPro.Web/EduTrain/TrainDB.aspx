...
<body>
        ...
        <Items>
            <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                ...
                <Items>
                    ...
                    <f:Tree ID="trTraining" EnableCollapse="true" ShowHeader="true" Title="考试试题库" OnNodeCommand="trTraining_NodeCommand"
                        ...
                        <Columns>                         
                            ...
                            <f:RenderField ColumnID="Abstracts" DataField="Abstracts" SortField="Abstracts" 
                             ...
                             <f:RenderField ColumnID="InstallationNames" DataField="InstallationNames" SortField="InstallationNames" 
                                Width="220px"  FieldType="String" HeaderText="适合岗位(装置/科室)" HeaderTextAlign="Center" TextAlign="left">
                            </f:RenderField> 
    ...
    <script type="text/javascript">
        var treeID = '<%= trTraining.ClientID %>';
