<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingEduSave.aspx.cs" Inherits="FineUIPro.Web.EduTrain.TrainingEduSave" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                   <f:TextBox ID="txtSupTrainingEdu" runat="server" Label="上级" Required="true" ShowRedStar="true" MaxLength="50" AutoPostBack="true" OnTextChanged="TextBox_TextChanged"></f:TextBox>
                </Items>
            </f:FormRow>  
            <f:FormRow>
                <Items>
