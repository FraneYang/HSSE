<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingItemIn.aspx.cs" Inherits="FineUIPro.Web.EduTrain.TrainingItemIn" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:Label ID="lblBottom" runat="server" Text="说明：1 导入模板为.xls后缀的EXCEL文件，黑体字为必填项。2 对于导入信息中重复记录自动过滤插入一条记录。3 题型为单选题、多选题、判断题，多岗位时用,隔开。4 适合岗位(装置/科室)空时为通用试题。 5 数据导入完成，成功后自动返回，如果有不成功数据页面弹出提示框，列表显示导入成功数据。">
                    </f:Label>
                </Items>
            </f:FormRow>
        </Rows>
