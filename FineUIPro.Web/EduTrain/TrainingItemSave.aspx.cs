    ...
    public partial class TrainingItemSave : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    var q = BLL.TrainingItemService.GetTrainingItemById(this.TrainingItemId);
                    if (q != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(q.TestType))
                        {
                            ...
                            System.Web.UI.WebControls.ListItem[] myList2 = BLL.TrainingItemService.GetAnswerItemsList(this.rblTestType.SelectedValue);
        ...
        private void SaveData(bool isClosed)
        {
            ...
            {
                trainingItem.InstallationIds = String.Join(",", DropDownBox1.Values);
                trainingItem.InstallationNames = String.Join(",", DropDownBox1.Texts);
            }
            ...
            if (String.IsNullOrEmpty(TrainingItemId))
            {
                ...
                BLL.LogService.AddLog(this.CurrUser.UserId, "添加考试试题库");
            }
            else
            {
                Model.Training_TrainingItem t = BLL.TrainingItemService.GetTrainingItemById(TrainingItemId);
                ...
                BLL.LogService.AddLog(this.CurrUser.UserId, "修改考试试题库");
            }
            if (isClosed)
            {
        ...
        protected void rblTestType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            System.Web.UI.WebControls.ListItem[] myList2 = BLL.TrainingItemService.GetAnswerItemsList(testType);
            RadioButtonList2.DataTextField = "Text";
            RadioButtonList2.DataValueField = "Value";
            RadioButtonList2.DataSource = myList2;
            RadioButtonList2.DataBind();
