    ...
    public partial class TrainingSave : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    var q = BLL.TrainingService.GetTrainingById(TrainingId);
                    if (q != null)
                    {
                ...
                var supq = BLL.TrainingService.GetTrainingById(this.SupTrainingId);
                if (supq != null)
                {
        ...
        {
            var standard = Funs.DB.Training_Training.FirstOrDefault(x => x.TrainingName == this.txtTrainingName.Text.Trim() && (x.TrainingId != this.TrainingId || (this.TrainingId == null && x.TrainingId != null)));
            if (standard != null)
            {
