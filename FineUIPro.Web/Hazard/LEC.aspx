<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LEC.aspx.cs" Inherits="FineUIPro.Web.Hazard.LEC" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
        <Items>
            <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                EnableCollapse="true" Width="220px" Title="所属单位" TitleToolTip="所属单位" ShowBorder="true"
            ...
            <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="LEC评价"
                TitleToolTip="LEC评价" AutoScroll="true">
                <Items>
                   <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="LEC评价" EnableCollapse="true"
                        ...
                        ClicksToEdit="2" DataIDField="DataId" AllowSorting="true" SortField="InstallationCode,WorkAreaCode,DataCode"
                        ...
                        <Toolbars>
                            <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Left">
                                 <Items>
                                    ...
                                    <f:RadioButtonList ID="ckDataType" runat="server" AutoPostBack="true" Label="评价对象"  LabelAlign="Right"
                                        AutoColumnWidth="true" OnSelectedIndexChanged="ckDataType_SelectedIndexChanged">                               
                                        <f:RadioItem Text="设备设施" Value="0" Selected="true"  />
                                        <f:RadioItem Text="作业环境" Value="1" />
                                    </f:RadioButtonList>
                                    <f:TextBox runat="server" Label="查询" ID="txtName" EmptyText="输入查询条件" AutoPostBack="true"
                                     ...
                                     <f:Button ID="btnHelp" runat="server" ToolTip="点击下载风险评价方法及说明" Text="LEC评价说明" Icon="Help">
                                        <Listeners>
                        ...
                        <Columns>                   
                            <%-- <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                                TextAlign="Center" />  --%>
                             <f:RenderField Width="110px" ColumnID="DataCode" DataField="DataCode" FieldType="String"
                                HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                            </f:RenderField>
                             <f:RenderField Width="110px" ColumnID="DataName" DataField="DataName" FieldType="String"
                                HeaderText="评价对象" HeaderTextAlign="Center" TextAlign="Left">
                            </f:RenderField> 
                            ...
                            <f:RenderField Width="140px" ColumnID="WorkAreaName" DataField="WorkAreaName" FieldType="String"
                            ...
                            <f:RenderField Width="80px" ColumnID="EuipmentNo" DataField="EuipmentNo" FieldType="String"
    ...
    <f:Window ID="Window1" Title="LEC评价" Hidden="true" EnableIFrame="true" EnableMaximize="true" 
    ...
    <script type="text/javascript">
        ...
        function onToolSourceCodeClick(event) {
            window.open('../File/Word/风险评价方法及说明/LEC风险评价法使用说明.doc', '_blank');
        }
    </script>
</body>
</html>
