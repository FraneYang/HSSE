<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BInterlocking.aspx.cs" Inherits="FineUIPro.Web.License.BInterlocking" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="B级联锁变更审批单" EnableCollapse="true"
    ...
    <f:Window ID="Window1" Title="B级联锁变更审批单" Hidden="true" EnableIFrame="true" EnableMaximize="true"
