<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlindPlate.aspx.cs" Inherits="FineUIPro.Web.License.BlindPlate" %>
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="盲板抽堵安全作业票" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField  ColumnID="EquipmentName" DataField="EquipmentName" SortField="EquipmentName" FieldType="String"
                         Width="250px" HeaderText="设备管道名称" HeaderTextAlign="Center" TextAlign="Left" ExpandUnusedSpace="true">
                    </f:RenderField>
                     <f:RenderField  ColumnID="Number" DataField="Number" SortField="Number" FieldType="String" Width="100px"
                        HeaderText="盲板编号" HeaderTextAlign="Center" TextAlign="Left" >
                    </f:RenderField>
                     <f:RenderField  ColumnID="EffectiveDate" DataField="EffectiveDate" SortField="EffectiveDate" Width="145px"
                        HeaderText="盲板实施时间" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField  ColumnID="Implement" DataField="Implement" SortField="Implement" FieldType="String" Width="100px"
                        HeaderText="盲板实施内容" HeaderTextAlign="Center" TextAlign="Left" >
                    </f:RenderField>                    
