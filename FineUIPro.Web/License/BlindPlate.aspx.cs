namespace FineUIPro.Web.License
{
    ...
    public partial class BlindPlate : PageBase
    {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("../ReportPrint/ExReportPrint.aspx?reportId={0}&&replaceParameter={1}&&varValue={2}", Const.BlindPlateMenuId, Grid1.SelectedRowID, "", "打印 - ")));
            }
        }
        #endregion
        ...
        private void ViewData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("BlindPlateView.aspx?BlindPlateId={0}", Grid1.SelectedRowID, "查看 - ")));
        }
        #endregion
    }
}