<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Electricity.aspx.cs" Inherits="FineUIPro.Web.License.Electricity" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="临时用电安全作业证" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="ElectricityId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="ElectricityId" AllowSorting="true" SortField="LicenseCode"
                ...
                <Columns>
                    ...
                    <f:RenderField  ColumnID="JobPalce" DataField="JobPalce" SortField="JobPalce" FieldType="String"
                         Width="250px" HeaderText="作业地点" HeaderTextAlign="Center" TextAlign="Left" ExpandUnusedSpace="true">
                    </f:RenderField>
                     <f:RenderField  ColumnID="AccessPoint" DataField="AccessPoint" SortField="AccessPoint" FieldType="String" Width="100px"
                        HeaderText="电源接入点" HeaderTextAlign="Center" TextAlign="Left" >
                    </f:RenderField>
    ...
    <f:Window ID="Window1" Title="临时用电安全作业证" Hidden="true" EnableIFrame="true" EnableMaximize="true"
