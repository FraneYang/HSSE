namespace FineUIPro.Web.License
{
    ...
    public partial class Electricity : PageBase
    {
        ...
        {
            string strSql = @"SELECT ElectricityId,LicenseCode,(CASE WHEN ApplyInstallation.InstallationName IS NULL THEN ApplyUnit.UnitName ELSE ApplyInstallation.InstallationName END) AS ApplyUintName,AccessPoint"
        ...
        private void ViewData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("ElectricityView.aspx?ElectricityId={0}", Grid1.SelectedRowID, "查看 - ")));
        }
        #endregion
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("../ReportPrint/ExReportPrint.aspx?reportId={0}&&replaceParameter={1}&&varValue={2}", Const.ElectricityMenuId, Grid1.SelectedRowID, "", "打印 - ")));
            }
        }
        #endregion
    }
