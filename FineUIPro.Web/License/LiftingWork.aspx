...
<body>
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="吊装安全作业证" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="LiftingTools" DataField="LiftingTools" 
    ...
    <f:Window ID="Window1" Title="吊装安全作业证" Hidden="true" EnableIFrame="true" EnableMaximize="true"
