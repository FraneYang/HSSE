<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Overhaul3.aspx.cs" Inherits="FineUIPro.Web.License.Overhaul3" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="仪表检修工作票" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="110px" ColumnID="InstallationName" DataField="InstallationName" 
                     ...
                     <f:RenderField Width="180px" ColumnID="DeviceName" DataField="DeviceName" ExpandUnusedSpace="true"
                        SortField="DeviceName" FieldType="String" HeaderText="设备名称" HeaderTextAlign="Center"
                        TextAlign="Left">                       
                    </f:RenderField> 
                    <f:RenderField  ColumnID="OverhaulUnit" DataField="OverhaulUnit" SortField="OverhaulUnit" FieldType="String"
                         Width="170px" HeaderText="检修单位" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField  ColumnID="OverhaulCategory" DataField="OverhaulCategory" SortField="OverhaulCategory" FieldType="String" Width="80px"
    ...
    <f:Window ID="Window1" Title="仪表检修工作票" Hidden="true" EnableIFrame="true" EnableMaximize="true"
