                ...
                <f:SimpleForm ID="SimpleForm1" BoxFlex="1" runat="server" ShowBorder="false" BodyPadding="10px" LabelAlign="Right"
                    ...
                    <Items>                                                
                        <f:TextBox ID="tbxUserName" Label="用户名" Required="true" ShowRedStar="true" runat="server"
                             Margin="0px 330px 0 330px" NextFocusControl="tbxPassword">
                        </f:TextBox>
                        ...
                        <f:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" Layout="HBox" BoxConfigAlign="Stretch" runat="server" Margin="0px 330px 0 330px">
                            <Items>
