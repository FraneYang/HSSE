<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News.aspx.cs" Inherits="FineUIPro.Web.Resources.News" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="新闻动态" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="NewsId" AllowCellEditing="true"
                EnableColumnLines="true" ClicksToEdit="2" DataIDField="NewsId" AllowSorting="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                        <Items>
                            <f:TextBox ID="txtNews" runat="server" Label="查询" EmptyText="输入查询文件编号"
                ...
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>                  
                    ...
                    <f:RenderField Width="280px" ColumnID="Title" DataField="Title" 
                    ...
                    <f:WindowField TextAlign="Center" Width="80px" WindowID="WindowAtt" HeaderText="附件"
                        Text="查看" ToolTip="附件上传查看" DataIFrameUrlFields="NewsId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/News&menuId=8D728939-4A60-48CE-BFB0-984FA33939EE"/>
                </Columns>
                <Listeners>
    ...
    <f:Window ID="Window1" Title="编辑新闻动态" Hidden="true" EnableIFrame="true" EnableMaximize="true"
