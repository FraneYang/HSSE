<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticesEdit.aspx.cs"
    Inherits="FineUIPro.Web.Resources.NoticesEdit" Async="true" ValidateRequest="false" %>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
             ...
             <f:FormRow>
                <Items>
                    <f:TextBox ID="txtReleaseUnit" runat="server" Height="60px" Label="发布单位" MaxLength="500">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:HtmlEditor runat="server" Label="公文公告内容" ID="txtOriginal" ShowLabel="false"
