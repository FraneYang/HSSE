    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="标牌管理" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="SignManageId" AllowCellEditing="true"
                EnableColumnLines="true" ClicksToEdit="2" DataIDField="SignManageId" AllowSorting="true"
                SortField="SignCode" SortDirection="ASC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server">
                        <Items>
                            <f:TextBox runat="server" Label="标牌编号" ID="txtSignCode" EmptyText="输入查询条件" AutoPostBack="true"
                                OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="80px" LabelAlign="Right">
                            </f:TextBox>
                            <f:DropDownList runat="server" ID="drpSignType" Label="标牌类型" EnableEdit="true" AutoPostBack="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="SignName" DataField="SignName" SortField="SignName"
                        FieldType="String" HeaderText="标牌名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    ...
                    <f:RenderField Width="120px" ColumnID="SignArea" DataField="SignArea" SortField="SignArea"
                        FieldType="String" HeaderText="标牌位置" HeaderTextAlign="Center" TextAlign="Left"
