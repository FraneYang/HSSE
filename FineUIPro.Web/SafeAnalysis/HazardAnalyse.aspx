<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HazardAnalyse.aspx.cs" Inherits="FineUIPro.Web.SafeAnalysis.HazardAnalyse" %>
                    ...
                    <f:Form ID="Form2" ShowHeader="false" ShowBorder="false" runat="server" LabelAlign="Right">
                        <Rows>
                            <f:FormRow ColumnWidths="66% 17% 17%">
                                <Items>
                                     <f:DropDownList ID="drpInstallation" runat="server" LabelWidth="50px" Label="装置"  
                                            OnClearIconClick="drpInstallation_ClearIconClick" EnableCheckBoxSelect="true"
