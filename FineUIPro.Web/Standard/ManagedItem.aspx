<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagedItem.aspx.cs" Inherits="FineUIPro.Web.Standard.ManagedItem" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="管理项目" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="ManagedItemId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="ManagedItemId" AllowSorting="true" SortField="SpecialtyCode,StandardCode,ManagedObjectCode,ManagedItemName"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />  
                    <f:RenderField Width="100px" ColumnID="ManagedItemCode" DataField="ManagedItemCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="150px" ColumnID="SpecialtyName" DataField="SpecialtyName" FieldType="String"
                    ...
                    <f:RenderField Width="150px" ColumnID="ManagedObjectName" DataField="ManagedObjectName" FieldType="String"
                     ...
                     <f:RenderField Width="150px" ColumnID="ManagedItemName" DataField="ManagedItemName" FieldType="String"
    ...
    <f:Window ID="Window1" Title="管理项目" Hidden="true" EnableIFrame="true" EnableMaximize="true"
