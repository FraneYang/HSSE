namespace FineUIPro.Web.Standard
{
    ...
    public partial class ManagedObject : PageBase
    {
        /// <summary>
        /// 加载页面
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            { 
                ...
                this.btnNew.OnClientClick = Window1.GetShowReference("ManagedObjectEdit.aspx") + "return false;";
                // 绑定表格
                this.BindGrid();
            }
        }
        ...
        private void EditData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("ManagedObjectEdit.aspx?ManagedObjectId={0}", Id, "编辑 - ")));
        }
        ...
        private void DeleteData()
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    {
                        BLL.ManagedObjectService.DeleteManagedObjectById(rowID);
                        BLL.LogService.AddLog(this.CurrUser.UserId, "删除管理对象");
                    }
                }
                BindGrid();
                ShowNotify("删除数据成功!");
        ...
        private bool judgementDelete(string id, bool isShow)
        {
            ...
            if (Funs.DB.Standard_ManagedItem.FirstOrDefault(x => x.ManagedObjectId == id) != null)
            {
                content = "该管理对象已在【管理项目】中使用，不能删除！";
            }
