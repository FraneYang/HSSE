...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
               <Items>
                     <f:TextBox ID="txtAuditFlowName" runat="server" Label="步骤名称"  LabelWidth="120px" LabelAlign="Right"
            ...
            <f:FormRow>
                <Items>
                    <f:NumberBox ID="txtPushGroup" runat="server" Label="组别" NoDecimal="true" NoNegative="true" CompareMessage="【组别】值不能小于1"
                        LabelWidth="120px" LabelAlign="Right" ShowRedStar="true" Required="true" CompareOperator="GreaterThanEqual" CompareValue="1"></f:NumberBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
               <Items>
                   <f:DropDownList ID="drpIsNeed" runat="server" Label="是否填写意见" EnableEdit="false" 
             ...
             <f:FormRow>
                <Items>
                    <f:DropDownBox runat="server" ID="drpWorkPosts" DataControlID="rbWorkPosts"  LabelWidth="120px" LabelAlign="Right"
                        EnableMultiSelect="true" ShowLabel="true" Label="审批岗位" EnableEdit="true">
                        <PopPanel>
                            <f:SimpleForm ID="SimpleForm2" BodyPadding="10px" runat="server" AutoScroll="true"
                                ...
                                <Items>
                                    ...
                                    <f:CheckBoxList ID="rbWorkPosts" ColumnNumber="3" runat="server">                                       
                                    </f:CheckBoxList>
                                </Items>
                            </f:SimpleForm>
                        </PopPanel>
