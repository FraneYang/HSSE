    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="角色管理" EnableCollapse="true"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="120px" HeaderTextAlign="Center" TextAlign="Center"/>                   
                    <f:RenderField Width="250px" ColumnID="RoleName" DataField="RoleName" EnableFilter="true"
                     ...
                     <f:RenderField Width="300px" ColumnID="AuthorizedRoleNames" DataField="AuthorizedRoleNames" 
