namespace FineUIPro.Web.SysManage
{
    ...
    public partial class RoleList : PageBase
    {
        ...
        {
            string strSql = @"SELECT Roles.RoleId,Roles.RoleName,Roles.RoleCode,Roles.Def,Roles.IsSystemBuilt,Roles.AuthorizedRoleIds,Roles.AuthorizedRoleNames"
                ...
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    if (judgementDelete(rowID, false))
                    {
                        ...
                        if (roles != null && ((!roles.IsSystemBuilt.HasValue || roles.IsSystemBuilt == false) || (roles.IsSystemBuilt == true && !BLL.CommonService.GetIsBuildUnit())))
                        {
                            ...
                            BLL.LogService.AddLog( this.CurrUser.UserId, "删除角色管理");
                        }
                    }
                }
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList( this.CurrUser.UserId, BLL.Const.RoleMenuId);
