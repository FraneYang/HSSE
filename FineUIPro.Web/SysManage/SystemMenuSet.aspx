            ...
            <Items>
               <f:TabStrip ID="TabStrip1" CssClass="f-tabstrip-theme-simple" Height="540px" ShowBorder="true"
                TabPosition="Top" MarginBottom="5px" EnableTabCloseMenu="false" runat="server">              
                   <Tabs>                                          
                        <f:Tab ID="Tab2" Title="菜单选择" BodyPadding="5px" Layout="VBox" IconFont="Bookmark" runat="server">
                            <Items>   
                                 <f:CheckBoxList ID="ckMenuType"  Label="菜单类型" runat="server" AutoColumnWidth="true"
                                   LabelAlign="Right" AutoPostBack="true" OnSelectedIndexChanged="ckMenuType_OnSelectedIndexChanged">
                                    <Items>
                                        ...
                                        <f:CheckItem Text="业务管理" Value="Menu_Project"  Selected="true"/>
                                        <f:CheckItem Text="资源管理" Value="Menu_Resource" />
                            ...
                            <Items>
                             ...
                             <Toolbars>
                                <f:Toolbar ID="Toolbar2" Position="Top" ToolbarAlign="Right" runat="server">
                                   <Items>
                                   <f:Button ID="btnTab1Save" Icon="TableRefresh" runat="server" ToolTip="更新全部菜单" ValidateForms="SimpleForm1"
                                        OnClick="btnTab1Save_Click" >
                                    </f:Button> 
                                    <f:Button ID="btnTab2Save" Icon="SystemSave" runat="server"  ValidateForms="SimpleForm1"
                                        OnClick="btnTab2Save_Click" ToolTip="保存启用菜单">
                                    </f:Button>                                     
                                </Items>
                                </f:Toolbar>
                            </Toolbars>
