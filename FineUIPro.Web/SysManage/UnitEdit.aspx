...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtUnitCode" runat="server" Label="单位代码" Required="true" MaxLength="20" ShowRedStar="true" FocusOnPageLoad="true" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                     <f:TextBox ID="txtUnitName" runat="server" Label="单位名称" Required="true" MaxLength="50" ShowRedStar="true" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                </Items>
            </f:FormRow>         
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtCorporate" runat="server" Label="法人代表" MaxLength="20">
                    </f:TextBox>
                </Items>
            </f:FormRow>            
            ...
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtAddress" runat="server" Label="单位地址" MaxLength="50">
                    </f:TextBox>
                </Items>
            </f:FormRow>
             <f:FormRow>
            ...
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtProjectRange" runat="server" Height="100px" Label="工程范围" MaxLength="600">
                    </f:TextArea>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:RadioButtonList runat="server" ID="rblIsThisUnit" Label="是否本单位">
