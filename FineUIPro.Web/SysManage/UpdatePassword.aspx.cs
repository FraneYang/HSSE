namespace FineUIPro.Web.SysManage
{
    ...
    public partial class UpdatePassword : PageBase
    {
        ...
        {
            string strSql = @"SELECT Users.UserId,Users.Account,Users.UserCode,Users.Password,Users.UserName,Users.RoleId,Users.UnitId,Users.IsPost,CASE WHEN  Users.IsPost=1 THEN '是' ELSE '否' END AS IsPostName,"
