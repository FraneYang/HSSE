...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        EnableColumnLines="true" BoxFlex="1" DataKeyNames="Account" AllowCellEditing="true"
                        ClicksToEdit="2" DataIDField="Account" AllowSorting="true" SortField="SortIndex"
                        ...
                        <Columns>
                            <f:TemplateField Width="50px" HeaderText="序号">
                             ...
                             <f:RenderField Width="80px" ColumnID="SortIndex" DataField="SortIndex" FieldType="String"
                                HeaderText="排列序号" HeaderTextAlign="Center" TextAlign="Left">
                            </f:RenderField>
                            ...
                            <f:RenderField Width="80px" ColumnID="UserName" DataField="UserName"
                             ...
                             <f:RenderField Width="100px" ColumnID="DepartName" DataField="DepartName" FieldType="String"
                                HeaderText="部门/中心" HeaderTextAlign="Center" TextAlign="Left">
                            </f:RenderField>
                             <f:RenderField Width="100px" ColumnID="InstallationName" DataField="InstallationName" FieldType="String"
                                HeaderText="科室/装置" HeaderTextAlign="Center" TextAlign="Left">
                            </f:RenderField>                           
                              <f:RenderField Width="140px" ColumnID="WorkPostName" DataField="WorkPostName" FieldType="String"
            ...
            <f:FormRow>
                <Items>
                    <f:Label ID="lblBottom" runat="server" Text="说明：1 人员信息导入模板为.xls后缀的EXCEL文件，黑体字为必填项。2 身份证号码必须为15或18位，所属单位、部门/中心等必须与基础信息中对应类型的名称一致,否则无法导入。3 科室/装置、岗位信息如果系统中不存在会自动插入一条记录。4 如需修改已有人员信息，请到系统中修改。5 数据审核后，点击“保存”，即可完成人员信息导入。">
                    </f:Label>
                </Items>
            </f:FormRow>
        </Rows>
