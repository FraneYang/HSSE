        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全评价" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:TemplateField Width="200px" HeaderText="标题" HeaderTextAlign="Center" TextAlign="Left"
                    ...
                    <f:TemplateField Width="350px" HeaderText="摘要" HeaderTextAlign="Center" TextAlign="Left"
                        SortField="Abstract">
                        <ItemTemplate>
                    ...
                    <f:WindowField TextAlign="Left" Width="100px" WindowID="WindowAtt" HeaderText="附件" HeaderTextAlign="Center" Text="附件上传查看"
