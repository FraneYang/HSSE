...
namespace FineUIPro.Web.Technique
{
    public partial class CheckItemSet :PageBase
    {
        ...
        private void GetNodes(TreeNodeCollection nodes, string parentId)
        {
            ...
            {
                var isEnd = BLL.CheckItemSetService.IsEndLevel(q.CheckItemSetId);
        ...
        protected void btnMenuDel_Click(object sender, EventArgs e)
        {
            if (this.tvCheckItemSet.SelectedNode != null)
            {
                ...
                {
                    BLL.CheckItemSetService.DeleteCheckItemSet(checkItemSetId);
                    BLL.LogService.AddLog(this.CurrUser.UserId, "删除检查项设置信息");
        ...
        protected void btnMenuDelDetail_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    BLL.CheckItemDetailService.DeleteCheckItemDetail(rowID);
                    BLL.LogService.AddLog(this.CurrUser.UserId, "删除检查明细信息");                   
                }
                BindGrid();
                ShowNotify("删除数据成功!");
            }
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.UserId, BLL.Const.TechniqueCheckItemSetMenuId);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            BLL.LogService.AddLog(this.CurrUser.UserId, "批量删除检查明细信息");
        }
        ...
        private void DeleteCheckItemSet(string supCheckItem)
        {
            ...
            else
            {
                ...
                if (checkItemSetEnd != null)
                {
                    ...
                    ////删除检查项
                    BLL.CheckItemSetService.DeleteCheckItemSet(checkItemSetEnd.CheckItemSetId);
                    ////删除检查项
                    BLL.CheckItemSetService.DeleteCheckItemSet(checkItemSetEnd.SupCheckItem);
                }
            }
        }
    }
