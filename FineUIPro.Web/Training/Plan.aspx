<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Plan.aspx.cs" Inherits="FineUIPro.Web.Training.Plan" %>
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="培训计划" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="300px" ColumnID="InstallationNames" DataField="InstallationNames" ExpandUnusedSpace="true"
                        FieldType="String" HeaderText="接受培训岗位(装置/科室)" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
