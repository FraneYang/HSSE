<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanView.aspx.cs" Inherits="FineUIPro.Web.Training.PlanView" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                   <f:TextBox ID="txtInstallationNames" runat="server" Label="适合岗位(装置)" LabelAlign="Right" Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
