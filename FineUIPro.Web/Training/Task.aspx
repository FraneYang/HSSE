<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Task.aspx.cs" Inherits="FineUIPro.Web.Training.Task" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="培训任务" EnableCollapse="true"
                ...
                ClicksToEdit="2" DataIDField="TaskId" AllowSorting="true" SortField="TaskDate,PlanName,UserName"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="200px" ColumnID="UserName" DataField="UserName" FieldType="String"
