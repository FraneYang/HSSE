    ...
    {        
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {                
                ...
                var q = BLL.TrainingEduItemService.GetTrainingEduItemById(Request.QueryString["TrainingEduItemId"]);
                if (q != null)
                {
        ...
        {
            PageContext.RegisterStartupScript(WindowAtt.GetShowReference(String.Format("../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/TrainingEduItemAttachUrl&menuId={1}&type=-1", Request.QueryString["TrainingEduItemId"], BLL.Const.TrainingEduMenuId)));
        }
        #endregion
    }
}