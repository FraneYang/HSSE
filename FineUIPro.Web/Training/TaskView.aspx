<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskView.aspx.cs" Inherits="FineUIPro.Web.Training.TaskView" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" ClicksToEdit="1"
                        AllowCellEditing="true" DataIDField="TrainingEduItemId" DataKeyNames="TrainingEduItemId" 
                        ...
                        PageSize="15" OnPageIndexChange="Grid1_PageIndexChange" EnableMultiSelect="false"
                         ShowGridHeader="true" EnableColumnLines="true" Height="500px" SortField="TrainingEduCode,TrainingEduItemCode"
                         EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick">                       
                        <Columns>
                            <f:RowNumberField ColumnID="rbNumber" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                                TextAlign="Center" />  
                            <f:RenderField Width="120px" ColumnID="TrainingEduCode" DataField="TrainingEduCode"
                            ...
                            <f:RenderField Width="100px" ColumnID="TrainingEduItemCode" DataField="TrainingEduItemCode"
