...
namespace FineUIPro.Web.Training
{
    public partial class TaskView : PageBase
    {
        ...
        private void BindGrid()
        {
            ...
            if (task != null)
            {
                string strSql = @"SELECT PlanItem.PlanItemId,PlanItem.PlanId,PlanItem.TrainingEduId,TrainingEdu.TrainingEduCode,TrainingEdu.TrainingEduId,TrainingEdu.TrainingEduName"
                                + @",TrainingEduItem.TrainingEduItemId,TrainingEduItem.TrainingEduItemCode,TrainingEduItem.TrainingEduItemName,TrainingEduItem.Summary,TrainingEduItem.InstallationIds,TrainingEduItem.InstallationNames"
