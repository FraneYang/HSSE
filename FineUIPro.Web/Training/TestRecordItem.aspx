<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestRecordItem.aspx.cs" Inherits="FineUIPro.Web.Training.TestRecordItem" %>
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                        <Items>
                            ...
                            <f:Button ID="btnClose" OnClick="btnClose_Click" runat="server" ConfirmText="确认关闭当前考生考试？"
                                ToolTip="关闭" Icon="Stop" Hidden="true">
                            </f:Button>
