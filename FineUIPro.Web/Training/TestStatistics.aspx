<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestStatistics.aspx.cs" Inherits="FineUIPro.Web.Training.TestStatistics" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="考试统计" EnableCollapse="true"
                ...
                ClicksToEdit="2" DataIDField="UserId" AllowSorting="true" SortField="UnitCode,DepartCode,InstallationName,UserCode"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="180px" ColumnID="InstallationName" DataField="InstallationName" SortField="InstallationName"
                    ...
                    <f:RenderField Width="100px" ColumnID="TestQualifyCount" DataField="TestQualifyCount" SortField="TestQualifyCount"
                        HeaderText="80分以上" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                </Columns>
                <Listeners>
