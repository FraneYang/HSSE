<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainRecord.aspx.cs" Inherits="FineUIPro.Web.Training.TrainRecord" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>           
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="培训任务" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="TrainingEduItemId" AllowCellEditing="true" EnableColumnLines="true"
                ClicksToEdit="2" DataIDField="TrainingEduItemId" AllowSorting="true" SortField="TrainingEduCode,TrainingEduItemCode"
                ...
                <Columns>
                    <f:RowNumberField ColumnID="rbNumber" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />  
                    <f:RenderField Width="90px" ColumnID="TrainingEduCode" DataField="TrainingEduCode"
                        FieldType="String" HeaderText="类型编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                        <f:RenderField Width="120px" ColumnID="TrainingEduName" DataField="TrainingEduName"
                        FieldType="String" HeaderText="教材类型" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="90px" ColumnID="TrainingEduItemCode" DataField="TrainingEduItemCode"
                        FieldType="String" HeaderText="教材编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                        <f:RenderField Width="150px" ColumnID="TrainingEduItemName" DataField="TrainingEduItemName"
