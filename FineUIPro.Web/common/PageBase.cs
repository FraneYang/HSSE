    ...
    public class PageBase : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (pm != null && !pm.IsFineUIAjaxPostBack)
            {
                ...
                HttpCookie compactModeCookie = Request.Cookies["EnableCompactMode_Pro"];
                if (compactModeCookie != null)
                {
                    bool compactMode = Convert.ToBoolean(compactModeCookie.Value);
                    pm.EnableCompactMode = compactMode;
                }
            }
