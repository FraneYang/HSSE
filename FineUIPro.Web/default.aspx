...
<body class="defaultpage">
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" Layout="Region" ShowBorder="false" ShowHeader="false" runat="server">
            <Items>
                                ...
                                <td style="text-align: right;">                                        
                                   <%-- <f:Button runat="server" CssClass="icontopaction nexttheme" ID="btnSever" Text="本部管理" ToolTip="本部管理系统"
                                     ...
                                     <f:Button runat="server" CssClass="icontopaction nexttheme" ID="btnPoject" 
                                        Text="业务功能"  ToolTip="业务功能管理系统" IconAlign="Top"  Icon="UserHome" 
                                        EnableDefaultState="false" EnableDefaultCorner="false" OnClick="btnPoject_Click">                                       
                                    </f:Button>                                   
                                     <f:Button runat="server" CssClass="icontopaction nexttheme" ID="btnResource" Text="资源管理" ToolTip="资源管理系统"
                ...
                <f:Panel ID="leftPanel" CssClass="leftregion" RegionPosition="Left" RegionSplit="true" RegionSplitWidth="3px"
                    ShowBorder="true" Width="200px" ShowHeader="true" Title="系统菜单"
                ...
                <f:TabStrip ID="mainTabStrip" CssClass="centerregion" RegionPosition="Center" ShowBorder="true" EnableTabCloseMenu="true" runat="server">
                    <Tabs>
                        <f:Tab ID="Tab1" Title="首页" IconFont="Home" EnableIFrame="true" IFrameUrl="./common/main.aspx" runat="server">
                        </f:Tab>
                    </Tabs>
                    <Tools>                                                                     
                    ...
                    <table class="bottomtable ui-widget-header f-mainheader">
                         <tr runat="server" id="trBottom">
                            ...
                            <td style="width: 199px;text-align: right;">
                              <a target="_blank" id="lbProject" runat="server"></a>
                            </td>
                            <td style="text-align: center;">
                              <a target="_blank" href="http://cncec.cn/" >Copyright © 2015 Copyrights ENN GROUP All Rights Reserved 新奥集团股份有限公司 版权所有</a>
                            </td>
                            <td style="width: 199px;text-align: right;">
                              <a target="_blank" href="http://www.enn.cn">新奥集团官网</a>
                            </td>
                            <td style="width: 50px;">&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                    </table>
        ...
        <f:Window ID="windowUserProfile" Title="个人信息" Hidden="true" EnableIFrame="true" IFrameUrl="./Personal/PersonalSet.aspx" ClearIFrameAfterClose="false"
